...
def runModel():
    ...
    # Plots
    plotsToGenerate = [plots["Experiment_Mood"], plots["Experiment_SelfProbabilitySuccess"], plots["Experiment_Losses"]]

    # Parameters for the game
    agent1 = AgentDQL.AgentDQL([True, 1.0, "I", intrinsicWithMoodDQL])  # training agent
    ...
    experimentDescriptor = "Training_PModel"
    ...
    saveExperimentsIn = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/EPIROB_Experiments/DQL/OponentMood/" # Directory where the experiment will be saved
