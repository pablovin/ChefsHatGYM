...
def runModel():
    ...
    agent2 = AgentPPO.AgentPPO([False, 1.0, "PPO", intrinsicWithMoodPPO]) #training agent
    ...
    saveExperimentsIn = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/EPIROB_Experiments/Hyp1_IntrinsicReward/"  # Directory where the experiment will be saved
