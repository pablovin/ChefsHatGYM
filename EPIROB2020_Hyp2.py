...
def runModel():
    ...
    #Intrinsic plugins
    intrinsicWithMoodDQL1 = Intrinsic(selfConfidenceType=CONFIDENCE_PHENOMENOLOGICAL, isUsingSelfMood=True,isUsingOponentMood=True)
    intrinsicWithMoodDQL2 = Intrinsic(selfConfidenceType=CONFIDENCE_PHENOMENOLOGICAL, isUsingSelfMood=True,isUsingOponentMood=True)
    intrinsicWithMoodPPO1 = Intrinsic(selfConfidenceType=CONFIDENCE_PHENOMENOLOGICAL, isUsingSelfMood=True,isUsingOponentMood=True)
    ...
    agent1 = AgentDQL.AgentDQL([False, 1.0, "DQL1", intrinsicWithMoodDQL1]) #training agent
    agent2 = AgentDQL.AgentDQL([False, 1.0, "DQL2", intrinsicWithMoodDQL2])  # training agent
    agent3 = AgentPPO.AgentPPO([False, 1.0, "PPO1", intrinsicWithMoodPPO1]) #training agent
    agent4 = AgentPPO.AgentPPO([False, 1.0, "PPO2", intrinsicWithMoodPPO2]) #training agent
    ...
    experimentDescriptor = "hundredGames"
    ...
    loadModelAgent2 = DQLModel# #""#[DQLModel9,DQLModel9]#""#""##[DQLModel2,DQLModel2]# ""#DQLModel #"" #DQLModel

    loadModelAgent3 = [PPOActor,PPOCritic]# ""#DQLModel3#[DQLModel3,DQLModel3] #[actorModelDDPG,criticModelDDPG]
    loadModelAgent4 =[PPOActor,PPOCritic]#""# DQLModel4# ""
    ...
    saveExperimentsIn = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/EPIROB_Experiments/Hyp2_intrinsicDifferent/"  # Directory where the experiment will be saved
