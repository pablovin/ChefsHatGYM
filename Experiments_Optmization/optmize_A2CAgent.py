...
def runModel():
    ...
    saveTrialsDataset = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/BaselineExperiments/Optmizing/AC2/" +  experimentDescriptor + ".p"
    ...
    saveExperimentsIn = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/BaselineExperiments/Optmizing/AC2/" # Directory where the experiment will be saved
    ...
    def objective(args):
        agent1 = AgentA2C.AgentA2C([True, 1.0])
        agent2 = AgentRandom.AgentRandom(AgentRandom.DUMMY_RANDOM)
        agent3 = AgentRandom.AgentRandom(AgentRandom.DUMMY_RANDOM)
        agent4 = AgentRandom.AgentRandom(AgentRandom.DUMMY_RANDOM)
        playersAgents = [agent1, agent2, agent3, agent4]
        ...
        return {
            ...
            'eval_time': time.time(),
            'other_stuff': {'wins': wins, "rounds": averageRounds, 'wrongMoves': p1_wrongActions, "BestModel":loadModelAgent1},
        }
