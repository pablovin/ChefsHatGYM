...
def runModel():
    ...
    experimentDescriptor = "Optmizing_DQL_Agent"

    saveTrialsDataset = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/BaselineExperiments/Optmizing/DQL/" +  experimentDescriptor
    ...
    saveExperimentsIn = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/BaselineExperiments/Optmizing/DQL" # Directory where the experiment will be saved
    ...
    def objective(args):
        ...
        #testing trial
        agent1 = AgentDQL.AgentDQL([False, 0.1])  # training agent
        playersAgents = [agent1, agent2, agent3, agent4]
