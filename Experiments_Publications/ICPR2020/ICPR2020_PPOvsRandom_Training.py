...
def runModel():
    ...
    plotFrequency = 200 #plot the plots every X games

    createDataset = True # weather to save the dataset

    saveExperimentsIn = "/home/pablo/Documents/Datasets/ChefsHat_ReinforcementLearning/ICPR_Experiments/PPO/Random/1000/NewQPlot/" # Directory where the experiment will be saved
